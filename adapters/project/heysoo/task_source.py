"""GitHub-Issues task source (target.md §5, build-fresh D8).

Replaces the dead roadmap-markdown source. ``resolve`` reads an issue via ``gh``;
``mark_complete`` posts a PR link comment. The subprocess runner is injectable so
